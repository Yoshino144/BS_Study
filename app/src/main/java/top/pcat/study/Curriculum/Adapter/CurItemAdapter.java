...
public class CurItemAdapter extends RecyclerView.Adapter<CurItemAdapter.ViewHolder> {
    ...
    public CurItemAdapter(List <Subject> fruitList){
    ...
    public void onBindViewHolder(ViewHolder holder, int position){
        ...
        holder.zz.setText("创始人:"+fruit.getFounderName());
