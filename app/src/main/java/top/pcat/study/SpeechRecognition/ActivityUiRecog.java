...
public abstract class ActivityUiRecog extends ExercisesActivity implements IStatus {
        ...
        switch (msg.what) { // 处理MessageStatusRecogListener中的状态回调
            case STATUS_FINISHED:
                if (msg.arg2 == 1) {
                    ...
                    String res = msg.obj.toString().substring(9,20);
                    if(res.contains("下")){
                        setCurrentView(1);
                    }
                    else if(res.contains("上")){
                        setCurrentView(-1);
                    }
                    else if(res.contains("a") || res.contains("A")){
                        setXuanXiang(1);
                    }
                    else if(res.contains("b") || res.contains("B") || res.contains("碧") ){
                        setXuanXiang(2);
                    }
                    else if(res.contains("c") || res.contains("C") ){
                        setXuanXiang(3);
                    }
                    else if(res.contains("d") || res.contains("D") || res.contains("地") || res.contains("弟")){
                        setXuanXiang(4);
                    }
//
//                    setCurrentView(1);
